    ...
    <main>
        <script>
            function confirmarEliminacion(event) {
                ...
                var confirmar = confirm("¿Estás seguro de que deseas editar el registro con ID: " + id + "?");
                if (!confirmar) {
        ...
        <div class="content" id="content">
            <h2 style="padding-top: 1%; padding-bottom: 2%">Editar - Samsung</h2>
            <form action="./updateForm.php" method="GET" onsubmit="confirmarEliminacion(event)">
                <label for="eliminar">ID: </label>
                <input type="number" name="editar" id="editar" required>
