...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $imagen_ruta = "../img/upload/apple/" . $imagen_nombre; // Cambiar la ruta según la ubicación de tus imágenes
    ...
    $sql = "INSERT INTO iphone (modelo, año_lanzamiento, gama, img, precio) VALUES (?, ?, ?, ?, ?)";
